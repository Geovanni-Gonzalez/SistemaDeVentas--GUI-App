...
class LoginWindow:
    def __init__(self, root, on_success):
        ...
        ttk.Label(card, text="Iniciar Sesión", style="H1.TLabel", background="white").pack(pady=(0, 20))

        ttk.Label(card, text="Usuario:", background="white").pack(fill='x')
        self.entry_user = ttk.Entry(card)
        self.entry_user.pack(fill='x', pady=(0, 15))

        ttk.Label(card, text="Contraseña:", background="white").pack(fill='x')
        ...
        tk.Label(card, text="Sistema de Ventas v1.0", bg="white", fg="gray", font=("Arial", 8)).pack(pady=(30,0))
